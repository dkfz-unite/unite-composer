...
public class CnvsData : RangeData
{
    ...
    public CnvsData(int[] range, Unite.Data.Entities.Omics.Analysis.Dna.Cnv.Variant variant) : base(range)
    {
...
public class Cnv
{
    ...
    public Cnv(Unite.Data.Entities.Omics.Analysis.Dna.Cnv.Variant variant)
    {
        Id = $"CNV{variant.Id}";
