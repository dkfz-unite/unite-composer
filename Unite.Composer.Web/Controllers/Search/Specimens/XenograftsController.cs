...
namespace Unite.Composer.Web.Controllers.Search.Specimens
{
    ...
    public class XenograftsController : Controller
    {
        ...
        public XenograftsController(ISearchService<SpecimenIndex, SpecimenSearchContext> searchService)
        {
        ...
        public SearchResult<SpecimenResource> Get()
        {
            ...
            var searchContext = new SpecimenSearchContext(SpecimenType.Xenograft);
