...
namespace Unite.Composer.Web.Controllers.Search.Specimens
{
    ...
    public class OrganoidsController : Controller
    {
        ...
        public OrganoidsController(ISearchService<SpecimenIndex, SpecimenSearchContext> searchService)
        {
        ...
        public SearchResult<SpecimenResource> Get()
        {
            ...
            var searchContext = new SpecimenSearchContext(SpecimenType.Organoid);
