...
namespace Unite.Composer.Web.Controllers.Search.Specimens
{
    ...
    public class OrganoidController : Controller
    {
        private readonly ISearchService<SpecimenIndex, SpecimenSearchContext> _searchService;


        public OrganoidController(ISearchService<SpecimenIndex, SpecimenSearchContext> searchService)
        {
        ...
        public SpecimenResource Get(int id)
        {
            ...
            var context = new SpecimenSearchContext(SpecimenType.Organoid);
