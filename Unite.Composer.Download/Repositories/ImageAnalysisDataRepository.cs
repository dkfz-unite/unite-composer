...
public class ImageAnalysisDataRepository : DataRepository
{
    public ImageAnalysisDataRepository(IDbContextFactory<DomainDbContext> dbContextFactory) : base(dbContextFactory)
    {
    }
