...
public class SpecimensDownloadService : DownloadService
{
    public SpecimensDownloadService(IDbContextFactory<DomainDbContext> dbContextFactory) : base(dbContextFactory)
    {
    }

    protected override Task<Data.Entities.Donors.Donor[]> GetDonors(IEnumerable<int> ids)
    {
        return _donorDataRepository.GetDonorsForSpecimens(ids);
    }

    protected override Task<Data.Entities.Donors.Clinical.Treatment[]> GetTreatments(IEnumerable<int> ids)
    {
        return _donorDataRepository.GetTreatmentsForSpecimens(ids);
    }


    protected override Task<Data.Entities.Images.Image[]> GetImages(IEnumerable<int> ids)
    {
        return _imageDataRepository.GetImagesForSpecimens(ids);
    }
    ...
    {
        return _specimenDataRepository.GetSpecimens(ids);
    }

    protected override Task<Data.Entities.Specimens.Intervention[]> GetInterventions(IEnumerable<int> ids)
    {
        return _specimenDataRepository.GetInterventions(ids);
    }
    ...
    {
        return _specimenAnalysisDataRepository.GetDrugsForSpecimens(ids);
    }
    ...
    {
        return _dnaAnalysisDataRepository.GetVariantsForSpecimens<SM.VariantEntry, SM.Variant>(ids, transcripts);
    }

    protected override Task<CNV.VariantEntry[]> GetCnvVariants(IEnumerable<int> ids, bool transcripts)
    {
        return _dnaAnalysisDataRepository.GetVariantsForSpecimens<CNV.VariantEntry, CNV.Variant>(ids, transcripts);
    }
